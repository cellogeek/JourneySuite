    ...
    return (
      ...
      >
        ...
        <div
          data-sidebar="sidebar"
          className={cn(
            "duration-200 fixed inset-y-0 hidden h-[calc(100svh-2rem)] my-4 flex-col transition-[left,right,width] ease-linear md:flex", 
            "w-[--sidebar-width]",
            side === "left"
              ? "left-4 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1_-_1rem)]" 
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:group-data-[state=expanded]:group-data-[side=left]/sidebar-wrapper:ml-[calc(var(--sidebar-width)_+_2rem)]", 
        ...
        "md:group-data-[state=collapsed]:group-data-[collapsible=offcanvas]/sidebar-wrapper:ml-0 md:group-data-[state=collapsed]:group-data-[collapsible=offcanvas]/sidebar-wrapper:mr-0", 
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-3 p-4 border-b border-brand-slate-200/50", className)} 
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-3 p-4 border-t border-brand-slate-200/50 mt-auto", className)} 
      {...props}
    />
  )
})
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2.5 overflow-hidden rounded-md p-2.5 text-left text-sm outline-none ring-sky-500 transition-colors duration-150 focus-visible:ring-2 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      ...
      isCollapsed: {
        true: "justify-center !size-10 !p-0", 
        false: "",
      }
    },
    defaultVariants: {
