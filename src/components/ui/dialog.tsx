  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-white/70 backdrop-blur-xl p-6 shadow-xl border border-brand-slate-200/80 rounded-2xl", // Glassmorphism
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-xl font-semibold leading-none tracking-tight text-slate-900", // Adjusted font size and color
      className
    )}
    {...props}
  />
