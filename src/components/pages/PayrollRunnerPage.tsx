...
const defaultEmployeesDataSeed = [
    // IDs will be generated by Firestore or client-side before first save
...
// --- Time and Date Helper Functions (Remain largely the same) ---
...
const PayrollRunnerPage = ({ pageId }: { pageId: string }) => {
    ...
    if (loadingAuth) {
        return (
            <div className="flex justify-center items-center h-screen">
                ...
                <p className="ml-4 text-slate-600">Loading User Data...</p>
            </div>
        );
    }
    ...
    const isLoading = isLoadingEmployees || isLoadingTimeEntries;
